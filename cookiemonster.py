...
class MonsterGui(QMainWindow):
    def __init__(self):
        ...
        self.actions = [QAction("launch attack",self.cookieWidget),QAction("stop monitor(Mac Only)", self.cookieWidget), QAction("resume monitor(Mac Only)", self.cookieWidget)]
        ...
        self.connect(self.actions[2], SIGNAL("triggered()"),self.resumeMonitor)
    ...
    def stopMonitor(self):
        if isinstance(self.Monster, MacMonsterCore):
